...
if [ -d __SW6_ADMINISTRATION_ASSET_FOLDER__ ] && [ -f __SW6_ADMINISTRATION_ASSET_FOLDER__/package.json ]; then
   npm --prefix __SW6_ADMINISTRATION_ASSET_FOLDER__ run lint-js --if-present || true;
   npm --prefix __SW6_ADMINISTRATION_ASSET_FOLDER__ run lint-css --if-present || true;
   fi
...
if [ -d __SW6_STOREFRONT_ASSET_FOLDER__ ] && [ -f __SW6_STOREFRONT_ASSET_FOLDER__/package.json ]; then
   npm --prefix __SW6_STOREFRONT_ASSET_FOLDER__ run lint-js --if-present || true;
   npm --prefix __SW6_STOREFRONT_ASSET_FOLDER__ run lint-css --if-present || true;
   fi
