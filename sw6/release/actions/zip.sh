...
if [ ! __SW6_IS_APP__ ]; then
      cd ../ && zip -FSr __SW6_PLUGIN_NAME__-__SW6_PLUGIN_VERSION__.zip __SW6_PLUGIN_NAME__ -x
         ...
         '__SW6_PLUGIN_NAME__/__SW6_ADMINISTRATION_ASSET_FOLDER__/build/webpack.config.js'
         ...
         '__SW6_PLUGIN_NAME__/__SW6_STOREFRONT_ASSET_FOLDER__/build/webpack.config.js'
